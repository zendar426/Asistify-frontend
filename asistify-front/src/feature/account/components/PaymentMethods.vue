...
<template>
    <div class="relative overflow-x-auto mt-10">
        <h1 class="font-bold text-xl">Métodos de pago asociados</h1>
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 mt-5">
        ...
        <tbody>
            <tr class="bg-white dark:bg-gray-800" v-for="(method,index) in paymentMethods" :key="method.name">
                ...
                <td class="px-6 py-4">
                    <BaseButton variant="secondary" size="lg" @click="deleteMethod(index)" class="m-5">
