...
<template>
    <div class="bg-white rounded-lg shadow p-4 space-y-4">
        <div class="flex gap-3">
            ...
            <BaseButton variant="outline" size="md" @click="showFilters = !showFilters">
            ...
            <BaseButton variant="primary" size="md" @click="emit('addDocument')">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path
                        stroke-linecap="round"
                        stroke-linejoin="round"
        ...
        >
            <div v-if="showFilters" class="flex gap-3 pt-2 border-t">
                ...
                <div class="flex items-end">
                    <BaseButton variant="outline" size="md" @click="clearFilters">
                        Limpiar filtros
                    </BaseButton>
                </div>
            </div>
