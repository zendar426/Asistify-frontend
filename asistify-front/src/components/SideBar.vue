  ...
  <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 ">
      ...
      <ul class="space-y-2 font-medium">
        ...
        <li>
          <RouterLink :to="{ name: 'receptionistDetail', params: { id: '123' } }" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-indigo-200 group">
        ...
        <li>
          <a @click="logout" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-indigo-200 group">
