...
<template>
  ...
  <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 ">
      <RouterLink to="/home" class="flex items-center ps-2.5 mb-5">
        <img src="../../public/assets/asistify.png" class="h-20 me-3" alt="Asistify Logo" />
        <span class="self-center text-xl font-semibold whitespace-nowrap text-gray-900">Asistify</span>
      </RouterLink>
      <ul class="space-y-2 font-medium">
        <li>
          <RouterLink to="/home" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
        ...
        <li>
          <RouterLink to="recepcionistas" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
            ...
            <span class="flex-1 ms-3 whitespace-nowrap">Recepcionistas</span>
          </RouterLink>
        </li>
        <li>
          <RouterLink to="cuenta" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
        ...
        <li>
          <RouterLink to="base-de-conocimiento" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
            <svg class="shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
            ...
            <path d="M13.75 2.25001V5.00001C13.75 5.96402 13.7516 6.61158 13.8165 7.09462C13.8786 7.55608 13.9858 7.75357 14.1161 7.88389C14.2464 8.01421 14.4439 8.12143 14.9054 8.18347C15.3884 8.24841 16.036 8.25001 17 8.25001H19.75V7.82843L19.7502 7.74838C19.7511 7.42271 19.7521 7.07122 19.6168 6.74452C19.4815 6.41783 19.2322 6.17 19.0013 5.94038L18.9445 5.88389L16.1161 3.05546L16.0596 2.99875C15.83 2.7678 15.5822 2.51854 15.2555 2.38322C14.9288 2.2479 14.5773 2.24891 14.2516 2.24985L14.1716 2.25001L13.75 2.25001Z"/>
            </svg>
            <span class="flex-1 ms-3 whitespace-nowrap">Base de conocimiento</span>
          </RouterLink>
        </li>
        <li>
          <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
